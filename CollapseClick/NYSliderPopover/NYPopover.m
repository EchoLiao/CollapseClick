...
//    UIColor* shadowColor2 = [UIColor colorWithRed: 0.524 green: 0.553 blue: 0.581 alpha: 0.3];
    ...
    UIColor* gradientColor  = [UIColor colorWithRed:78/255.0 green:22/255.0 blue:114/255.0 alpha:0.25];
    UIColor* gradientColor2 = [UIColor colorWithRed:78/255.0 green:22/255.0 blue:114/255.0 alpha:0.25];
    UIColor* shadowColor2   = [UIColor colorWithRed:78/255.0 green:22/255.0 blue:114/255.0 alpha:0.25];
    ...
    [[UIColor colorWithRed:78/255.0 green:22/255.0 blue:114/255.0 alpha:0.55] setStroke];

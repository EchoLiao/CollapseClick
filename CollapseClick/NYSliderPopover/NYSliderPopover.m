...
- (void)commonSetup 
{
//	[self setThumbImage:[UIImage imageNamed:@"ACVRangeSelector.bundle/Images/pointer-handle.png"] forState:UIControlStateNormal];
//	[self setMinimumTrackImage:[UIImage imageNamed:@"ACVRangeSelector.bundle/Images/connector.png"] forState:UIControlStateNormal];
//	[self setMaximumTrackImage:[UIImage imageNamed:@"ACVRangeSelector.bundle/Images/track.png"] forState:UIControlStateNormal];

	[self setThumbImage:[UIImage imageNamed:@"py_slider_thumb"] forState:UIControlStateNormal];
	[self setThumbImage:[UIImage imageNamed:@"py_slider_thumb3"] forState:UIControlStateHighlighted];
	[self setMinimumTrackImage:[UIImage imageNamed:@"py_slider_track"] forState:UIControlStateNormal];
	[self setMaximumTrackImage:[UIImage imageNamed:@"py_slider_track_bg"] forState:UIControlStateNormal];
}
...
- (void)updatePopoverFrame
{
    ...
    popoverRect.origin.y = self.frame.origin.y - popoverRect.size.height - (-6);

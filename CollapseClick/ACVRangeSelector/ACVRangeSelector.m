...
- (void)commonSetup {
    ...
    _minimumValue = (float)INT_MIN;
    _maximumValue = (float)INT_MAX;
    _leftValue = _minimumValue;
    _rightValue = _maximumValue;
...
//        _trackImage = [[UIImage imageNamed:@"ACVRangeSelector.bundle/Images/track.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 3, 0, 3)];
        _trackImage = [[UIImage imageNamed:@"py_slider_track_bg"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 3, 0, 3)];
...
//        data[kConnectionImage] = [[UIImage imageNamed:@"ACVRangeSelector.bundle/Images/connector.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 4, 0, 4)];
        ...
        data[kLeftThumbImage] = [UIImage imageNamed:@"py_handle"]; // 32x60
        data[kRightThumbImage] = [UIImage imageNamed:@"py_handle"];
        data[kMiddleThumbImage] = [UIImage imageNamed:@"py_c_handle"];
        data[kConnectionImage] = [[UIImage imageNamed:@"py_slider_track"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 4, 0, 4)];
    }
}
